...
/// </summary>
public static class OpenIddictClientUnoIntegrationHelpers
{
    /// <summary>
    /// Gets the <see cref="OpenIddictClientUnoIntegrationActivation"/> associated with the current context.
    /// </summary>
    /// <param name="transaction">The transaction instance.</param>
    /// <returns>The <see cref="OpenIddictClientUnoIntegrationActivation"/> instance or <see langword="null"/> if it couldn't be found.</returns>
    public static OpenIddictClientUnoIntegrationActivation? GetProtocolActivation(this OpenIddictClientTransaction transaction)
        => transaction.GetProperty<OpenIddictClientUnoIntegrationActivation>(typeof(OpenIddictClientUnoIntegrationActivation).FullName!);
